  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-xl bg-white rounded-[40px] shadow-[0_32px_64px_rgba(106,13,173,0.2)] overflow-hidden animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-10">
          {/* ส่วนแสดงรายละเอียดแพ็กเกจที่เลือก */}
          ...
          {/* รายละเอียดการคำนวณ Subtotal, VAT และ Grand Total */}
          ...
          {/* ปุ่มสำหรับยืนยันและไปขั้นตอนชำระเงินต่อ */}
          <div className="space-y-4">
            <button 
              onClick={onConfirm} // เมื่อกดให้เรียกฟังก์ชันเปิดป๊อปอัปถัดไป (Payment Modal)
