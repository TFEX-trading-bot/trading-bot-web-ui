...
export default function AddBotCard() {
  return (
    <button className="group flex h-[210px] w-full flex-col items-center justify-center rounded-[24px] border-2 border-dashed border-[#D8B4FE] bg-[#F3E8FF] transition-all hover:bg-[#E9D5FF] hover:border-[#C084FC]">
